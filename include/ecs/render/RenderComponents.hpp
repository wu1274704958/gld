...
namespace gld::ecs {
    ...
    struct RenderDiagnostics {
        ...
        std::uint64_t batch_full_upload_bytes = 0;
        std::uint64_t batch_partial_upload_bytes = 0;
        std::uint32_t batch_full_uploads = 0;
        std::uint32_t batch_partial_uploads = 0;
        std::uint32_t batch_upload_ranges = 0;
        double batch_prepare_ms = 0.0;
        double batch_upload_ms = 0.0;
        double batch_submit_ms = 0.0;
        ...
        void begin_frame() {
            ...
            batch_full_upload_bytes = 0;
            batch_partial_upload_bytes = 0;
            batch_full_uploads = 0;
            batch_partial_uploads = 0;
            batch_upload_ranges = 0;
