...
public:
    ...
    void init_lrc()
    {
        ...
        lrc_view->create();
        lrc_view->get_comp<Transform>()->pos = glm::vec3(0.f,-0.86f,0.236f);
        lrc_view->get_comp<Transform>()->setRotateX(-27.f);
        //lrc_view->get_comp<Transform>()->pos = glm::vec3(0.f,0.f,0.32f);
