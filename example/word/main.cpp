...
public:
    ...
    int init() override
    {
        ...
        program = DefDataMgr::instance()->load<DataType::Program>("base/line_vs.glsl","base/line_fg_old.glsl");
        program->use();
        ...
        wp->create();
        //auto a = create_word(font2,L'��', onclick, onMove, onDown);
        ...
        for (auto k = 0x5434; k <= 0x5434 + 300; ++k)
        {
        ...
        //clip->refresh();
        //
        //clip->node->add_child(create_word(font2, L'��', onclick, onMove, onDown,126,1.0f,0.0f));
